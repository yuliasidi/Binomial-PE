...
saveRDS(dt.mar.check,file = sprintf('wndochmar25_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtwnmar25_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarwn25_%d.rds',idx))
