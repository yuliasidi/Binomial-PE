...
saveRDS(dt.mnar.check,file = sprintf('wndochmnar25_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtwnmnar25_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarwn25_%d.rds',idx))
