...
saveRDS(dt.mnar.check,file = sprintf('fmdochmnar20_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtfmmnar20_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarfm20_%d.rds',idx))
