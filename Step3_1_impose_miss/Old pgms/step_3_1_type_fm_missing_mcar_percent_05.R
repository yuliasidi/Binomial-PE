...
saveRDS(dt.mcar.check,file = sprintf('fmdochmcar05_%d.rds',idx))

saveRDS(dt.mcar,file = sprintf('dtfmmcar05_%d.rds',idx))
...
saveRDS(check.mech.mcar,file = sprintf('mechmcarfm05_%d.rds',idx))
