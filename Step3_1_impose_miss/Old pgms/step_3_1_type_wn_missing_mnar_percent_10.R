...
saveRDS(dt.mnar.check,file = sprintf('wndochmnar10_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtwnmnar10_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarwn10_%d.rds',idx))
