...
saveRDS(dt.mar.check,file = sprintf('wndochmar05_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtwnmar05_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarwn05_%d.rds',idx))
