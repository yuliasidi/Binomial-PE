...
saveRDS(dt.mar.check,file = sprintf('fmdochmar20_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtfmmar20_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarfm20_%d.rds',idx))
