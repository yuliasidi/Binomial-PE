...
saveRDS(dt.mnar.check,file = sprintf('walddochmnar05_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtwaldmnar05_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarwald05_%d.rds',idx))
