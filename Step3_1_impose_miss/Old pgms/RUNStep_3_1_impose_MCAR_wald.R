...
build_template(
  file = 'Step_3_1_impose_MCAR_wald.R',
  args = c('$(Process)'),
  tag = 'MCARwald',
  jobs = 1,
  init_dir = 'jobs/run',
  template_file = 'Step3_1_impose_miss/Step_3_1_impose_MCAR_wald.condor',
  input_files = c('../myfiles/lib/','Step_0_init.R', 'PE_Bin_PD_Functions.R',
                  sprintf('../savedata/dtfullwald_$(Process).rds'),
                  sprintf('../savedata/dtfullwaldxm30_$(Process).rds'),
                  sprintf('../savedata/dtfullwaldxmm_$(Process).rds'),
                  sprintf('../savedata/dtfullwaldxp80_$(Process).rds')),
  job_type = 'short')
...
ssh::scp_upload(session,
                files = c('Step3_1_impose_miss/Step_3_1_impose_MCAR_wald.R',
                          'Step3_1_impose_miss/Step_3_1_impose_MCAR_wald.condor'),
                to = '~'
)

condor::create_dirs(session, file = 'Step3_1_impose_miss/Step_3_1_impose_MCAR_wald.condor')
...
condor::condor_submit(session,'Step_3_1_impose_MCAR_wald.condor',sleeptime='10m')
