...
saveRDS(dt.mnar.check,file = sprintf('wndochmnar15_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtwnmnar15_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarwn15_%d.rds',idx))
