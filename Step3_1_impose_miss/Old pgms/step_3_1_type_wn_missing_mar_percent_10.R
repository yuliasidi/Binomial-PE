...
saveRDS(dt.mar.check,file = sprintf('wndochmar10_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtwnmar10_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarwn10_%d.rds',idx))
