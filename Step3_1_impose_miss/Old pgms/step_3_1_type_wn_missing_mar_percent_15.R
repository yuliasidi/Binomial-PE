...
saveRDS(dt.mar.check,file = sprintf('wndochmar15_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtwnmar15_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarwn15_%d.rds',idx))
