...
saveRDS(dt.mcar.check,file = sprintf('wndochmcar05_%d.rds',idx))

saveRDS(dt.mcar,file = sprintf('dtwnmcar05_%d.rds',idx))
...
saveRDS(check.mech.mcar,file = sprintf('mechmcarwn05_%d.rds',idx))
