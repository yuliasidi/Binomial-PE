...
saveRDS(dt.mnar.check,file = sprintf('wndochmnar20_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtwnmnar20_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarwn20_%d.rds',idx))
