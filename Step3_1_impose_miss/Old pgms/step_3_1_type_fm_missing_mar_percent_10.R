...
saveRDS(dt.mar.check,file = sprintf('fmdochmar10_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtfmmar10_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarfm10_%d.rds',idx))
