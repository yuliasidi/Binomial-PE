...
saveRDS(dt.mcar.check,file = sprintf('wndochmcar20_%d.rds',idx))

saveRDS(dt.mcar,file = sprintf('dtwnmcar20_%d.rds',idx))
...
saveRDS(check.mech.mcar,file = sprintf('mechmcarwn20_%d.rds',idx))
