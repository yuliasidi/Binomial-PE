...
saveRDS(dt.mcar.check,file = sprintf('walddochmcar10_%d.rds',idx))

saveRDS(dt.mcar,file = sprintf('dtwaldmcar10_%d.rds',idx))
...
saveRDS(check.mech.mcar,file = sprintf('mechmcarwald10_%d.rds',idx))
