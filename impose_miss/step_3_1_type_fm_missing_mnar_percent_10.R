...
saveRDS(dt.mnar.check,file = sprintf('fmdochmnar10_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtfmmnar10_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarfm10_%d.rds',idx))
