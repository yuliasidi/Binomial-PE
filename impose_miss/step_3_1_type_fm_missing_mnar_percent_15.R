...
saveRDS(dt.mnar.check,file = sprintf('fmdochmnar15_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtfmmnar15_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarfm15_%d.rds',idx))
