...
saveRDS(dt.mnar.check,file = sprintf('fmdochmnar25_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtfmmnar25_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarfm25_%d.rds',idx))
