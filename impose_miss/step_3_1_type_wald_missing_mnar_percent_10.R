...
dt.mnar <- miss.apply.do(dt.full.X, b.trt=log(1), b.y=log(10), b.X=log(10), do=0.10)
...
saveRDS(dt.mnar.check,file = sprintf('walddochmnar10_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtwaldmnar10_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarwald10_%d.rds',idx))
