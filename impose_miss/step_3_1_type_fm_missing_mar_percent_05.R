...
saveRDS(dt.mar.check,file = sprintf('fmdochmar05_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtfmmar05_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarfm05_%d.rds',idx))
