...
saveRDS(dt.mar.check,file = sprintf('fmdochmar15_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtfmmar15_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarfm15_%d.rds',idx))
