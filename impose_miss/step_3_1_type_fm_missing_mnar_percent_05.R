...
saveRDS(dt.mnar.check,file = sprintf('fmdochmnar05_%d.rds',idx))

saveRDS(dt.mnar,file = sprintf('dtfmmnar05_%d.rds',idx))
...
saveRDS(check.mech.mnar,file = sprintf('mechmnarfm05_%d.rds',idx))
