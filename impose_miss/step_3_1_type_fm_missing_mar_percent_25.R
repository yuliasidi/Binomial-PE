...
saveRDS(dt.mar.check,file = sprintf('fmdochmar25_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtfmmar25_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarfm25_%d.rds',idx))
