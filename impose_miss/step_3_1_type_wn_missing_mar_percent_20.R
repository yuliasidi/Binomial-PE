...
saveRDS(dt.mar.check,file = sprintf('wndochmar20_%d.rds',idx))

saveRDS(dt.mar,file = sprintf('dtwnmar20_%d.rds',idx))
...
saveRDS(check.mech.mar,file = sprintf('mechmarwn20_%d.rds',idx))
