...
saveRDS(dt.mcar.check,file = sprintf('wndochmcar15_%d.rds',idx))

saveRDS(dt.mcar,file = sprintf('dtwnmcar15_%d.rds',idx))
...
saveRDS(check.mech.mcar,file = sprintf('mechmcarwn15_%d.rds',idx))
