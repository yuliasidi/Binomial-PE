...
saveRDS(x1, sprintf("cluster/out/wald/2xcont/do%d/cont2xH0_%s_%s_sc%d_do%d_param%d.rds", 
                    round(100*do.val,0), method, anal.type, scenario, round(100*do.val,0), param))
