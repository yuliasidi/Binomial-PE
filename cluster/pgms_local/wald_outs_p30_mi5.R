...
ff.n1 <- ff.n%>%filter(scenario%in%c(3,5,13,15,17,19,21), do==20)%>%
  bind_rows(ff.n%>%filter(scenario%in%c(13,15,17,19,21), do==10))



t1.H0 <- pmap_df(as.list(ff.n1), .f = function(scenario, do, setn){
  t <-readRDS(sprintf("cluster/out/wald/mi5/outH0_p30_wald%d_%d_set%d_mi5.rds", scenario, do, setn))
  t1 <- t%>%
    dplyr::bind_rows()%>%
...
pdf("cluster/out/wald/plots/mi5/type1_mar10_wald_ccamice_p30.pdf")
type1.plot.10.mar.ccamice
dev.off()

pdf("cluster/out/wald/plots/mi5/type1_mar20_wald_ccamice_p30.pdf")
type1.plot.20.mar.ccamice
dev.off()

##### Bias

pdf("cluster/out/wald/plots/mi5/bias_mar10_wald_ccamice_p30.pdf")
bias.plot.10.mar.ccamice
dev.off()

pdf("cluster/out/wald/plots/mi5/bias_mar20_wald_ccamice_p30.pdf")
bias.plot.20.mar.ccamice
dev.off()
...
pdf("cluster/out/wald/plots/mi5/power_mar10_wald_ccamice_p30.pdf")
power.plot.10.mar.ccamice
dev.off()

pdf("cluster/out/wald/plots/mi5/power_mar20_wald_ccamice_p30.pdf")
power.plot.20.mar.ccamice
dev.off()
