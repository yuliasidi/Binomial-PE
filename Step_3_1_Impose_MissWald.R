...
saveRDS(dt.miss.check,file = sprintf('docheck_%d.rds',idx))

saveRDS(dt.mcar,file = sprintf('dtmcarwald_%d.rds',idx))
saveRDS(dt.mar, file = sprintf('dtmarwald_%d.rds',idx))
saveRDS(dt.mnar,file = sprintf('dtmnarwald_%d.rds',idx))
...
saveRDS(check.mech.mcar,file = sprintf('mechmcarwald_%d.rds',idx))
saveRDS(check.mech.mar, file = sprintf('mechmarwald_%d.rds',idx))
saveRDS(check.mech.mnar,file = sprintf('mechmnarwald_%d.rds',idx))
